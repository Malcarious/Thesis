...
%\documentclass[12pt, doublespace]{uofsthesis-cs}
...
\loa{\abbrev{ALI}{Aerosol Limb Imager}
...
\abbrev{MART}{Multiplicative Algebraic Reconstruction Technique}
...
\input{./AppendixA/AliHardwareComponents.tex}
\input{./AppendixB/AliSoftwareCommands.tex}
